...
4. <s>快速輸入【粵拼】</s>
**目前：無法識別複雜詞組/句子**
5. <s>在【倉頡】模式下，直接輸入【粵拼】碼</s>
**目前：無法在此模式下連續輸入粵拼碼**
6. <s>輸入【粵拼】，顯示【倉頡】提示</s>
**目前：僅限於單字**
7. <s>輸入【倉頡】，顯示【粵拼】提示</s>
**目前：無法在詞組句子中顯示提示｜只有單字有提示**
8. **修復並完善功能 <4>**
9. **修復並完善功能 <5>**
10. **修復並完善功能 <6>**
11. **修復並完善功能 <7>**
12. 快速輸入【倉頡】（期望：<i>同時提供【速成倉頡】候選字，即為快倉</i>）
13. 快速輸入【倉頡】的詞組/句子（期望：<i>輸入[你]，提供[你好]等常用候選詞組</i>）
14. 自定義詞庫（讓使用者快速輸入【email、個人資料等】）
15. 輸入英文顯示中文
16. 集成日文輸入
17. 輸入日期與時間

## 以下內容摘自[原始倉頡輸入法庫](https://github.com/rime/rime-cantonese)
